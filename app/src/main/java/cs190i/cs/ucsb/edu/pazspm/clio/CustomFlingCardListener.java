...
public class CustomFlingCardListener implements View.OnTouchListener {

    private static final String TAG = CustomFlingCardListener.class.getSimpleName();
    ...
    public CustomFlingCardListener(View frame, Object itemAtPosition, FlingListener flingListener) {
        this(frame, itemAtPosition, 15f, flingListener);
    }

    public CustomFlingCardListener(View frame, Object itemAtPosition, float rotation_degrees, FlingListener flingListener) {
        super();
        this.frame = frame;
    ...
    private float getExitPoint(int exitXPoint) {
        ...
        CustomLinearRegression regression = new CustomLinearRegression(x, y);
